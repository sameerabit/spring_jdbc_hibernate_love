...
<html class="csstransforms no-csstransforms3d csstransitions"><head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/function.js"></script>
...
<div id="wrap">
    <header>
        <div class="inner relative">
            <a class="logo" href="http://www.freshdesignweb.com"><img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="fresh design web"></a>
